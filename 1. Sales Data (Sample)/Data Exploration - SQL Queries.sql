...
FROM Sales
GROUP BY Country
ORDER BY SUM(sales) DESC;	--I used the aggregate function 'SUM(sales)' to sort the results because the output of the 'Total Sales' column is nvarchar / string format
